...
class UserActivity_Note{
	 ...
	 * @return array          array containing UserActivity_Note objects
	 */
	public static function get_all($user_id){
		...
		$notes = apply_filters('usin_notes_list', $notes, $user_id);
	...
	public static function note_post_to_obj($np){
		$note = new UserActivity_Note($np->ID);
		$note->date = UserActivity_Helper::format_date($np->post_date);
