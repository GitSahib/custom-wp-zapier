...
class UserActivity_Field_Defaults{
	protected static $all_groups;
	protected static $slug = "usin_group";
	protected static $color_meta_key = "usin_color";
	public static function get_fields(){
		$fields = array(
			...
			array(
				...
				'filter' => array(
					'type' => 'select',
					'options' => UserActivity_Helper::get_roles(),
					'disallow_null' => true
				)
			),
			array(
		...
		$field_types = array(
			...
			'serialized_multioption' => array(
				'operators' => array(
					...
					array('key' => 'isset_ser' , 'val' => __('is set', 'usin')),
					array('key' => 'notset_ser' , 'val' => __('is not set', 'usin'))
				),
				'type' => 'option'
			),
